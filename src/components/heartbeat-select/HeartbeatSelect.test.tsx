...
import HeartBeat from "./HeartbeatSelect";
...
describe("Select Component", () => {
  ...
  it("renders the select component with options", () => {
    ...
    render(
      <FormProvider {...result.current}>
        <HeartBeat name="testSelect" options={options} />
      </FormProvider>,
    );
  ...
  it("renders with a label if provided", () => {
    ...
    render(
      <FormProvider {...result.current}>
        <HeartBeat name="testSelect" options={options} label="Test Label" />
      </FormProvider>,
    );
  ...
  it("renders without errors when no options are provided", () => {
    ...
    render(
      <FormProvider {...result.current}>
        <HeartBeat name="testSelect" options={[]} />
      </FormProvider>,
    );
